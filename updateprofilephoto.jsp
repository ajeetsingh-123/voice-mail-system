...
<header class="w3-container w3-teal" style="width:100%;">
	...
	<div class="w3-container">
		<center><br>
		<center><br>
				<b style="color:red;font-size:20pt;">UPDATE YOUR PROFILE PHOTO HERE...</b>
				<br>
				<form name="upload" method="post" enctype="multipart/form-data" action="updateprofile.jsp"> 
					<br>
					<br>
					...
					<br>
					<input type="submit" class="w3-btn w3-round-large w3-blue" name="upload_cover" value="UPDATE" />
