...
<%
	...
	String attachments = uploadFile(application.getRealPath("/voice_mail/attachments"), "", request);
    Class.forName("oracle.jdbc.OracleDriver");
    Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","ajeet");
    String sql="update message set attachment='"+attachments+"' where uname='"+uname+"' and receiver='"+receiver+"' and td='"+td+"'";
    PreparedStatement pst=con.prepareStatement(sql);
    int x=pst.executeUpdate();
    if(x>0)
    {
		response.sendRedirect("sendvoicemail.jsp");
    }
    else
    {
		%>
